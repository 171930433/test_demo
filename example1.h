...
typedef multi_index_container<employee, indexed_by<ordered_unique<tag<id>, member<employee, int, &employee::id>>,
...
TEST(multi_index_container, Test1) {
  EXPECT_EQ(fun1(), 0);  // 2 + 3 = 5
}